...
var Game = new (function() {
  var self = this,
      ...
      ojoos = ['Прекрасно','Здорово','Отлично','Мудро','Гениально','Идеально','Мощно','Вау','Хорошо','Супер'],
  ...
  function start() {
    ...
    setTimeout(function(){$('.hide0').removeClass('hide0')}, 0);
    setTimeout(function(){$('.hide1').removeClass('hide1')}, 1);
    setTimeout(function(){$('.show01').removeClass('hidehs')}, 1);
    setTimeout(function(){$('.show01').removeClass('show01').addClass('hidehs'); addEventListeners();}, 1);
  }
  ...
  function showSizes() {
    onHomeScreen = false;
    showGame();
    $('#boardsize').html('<span>Размер</span>');
