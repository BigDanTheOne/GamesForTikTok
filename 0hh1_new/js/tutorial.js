...
var TutorialMessages = {
  1: { msg: 'Нажми на плитку, чтобы сделать ее красной.', tiles: [ [0,0,1] ] },
  2: { msg: 'Отлично! Нажми дважды, чтобы сделать ее синей.', tiles: [ [0,1,2] ] },
  3: { msg: 'Три красные подряд в одном ряду запрещены', tiles: [ [2,0,2] ] },
  4: { msg: 'Три синие - тоже.', tiles: [ [1,1,1] ] },
  5: { msg: 'Не допускай три одноцветные в столбце', tiles: [ [1,2,2], [2,2,1] ] },
  6: { msg: 'В ряду красных и синих должно быть поровну', tiles: [ [3,1,1] ], rows: [1] },
  7: { msg: 'В колоннах тоже', tiles: [ [1,3,2] ], cols: [1] },
  8: { msg: '', tiles: [ [2,3,1], [0,3,1] ] },
  9: { msg: 'Еще один момент...<br>Ряды должны быть различны.', tiles: [ [0,2,2],[3,2,1] ], rows:[2,3] },
  10: { msg: 'Если застрял - выбери подсказку', tiles: [ [3,0,2] ], wiggle: true }
}
