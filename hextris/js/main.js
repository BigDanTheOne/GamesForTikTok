...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>Как играть?</div><p> Ваша цель - не допустить выход блоков за границу внешней фигуры</p><p>" + (settings.platform != 'mobile' ? 'Нажимай на стрелки' : 'Нажимай на левую и правую часть экрана') + " чтобы вращать внутреннюю фигуру" + "." + (settings.platform != 'mobile' ? ' Нажми на нижнюю стрелку, чтобы ускорить падение блока': '') + " </p><p>Если собрать 3 блока одного цвета, то блоки удаляются и начисляются очки.</p><p>")
	if (gameState == 1) {
		pause();
	}
