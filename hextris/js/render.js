...
function renderBeginningText() {
    ...
    if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        mob = true;
        input_text = 'Нажимай на экран слева и справа'//'Tap the screen\'s left and right'
        action_text = 'для вращения'//'sides to rotate the hexagon'
        score_text = '3+ блока одного цвета удаляются'//'Match 3+ blocks to score'
        fontSize = 35
    } else {
        mob = false
		input_text = 'Нажимай на экран слева и справа'//'Tap the screen\'s left and right'
